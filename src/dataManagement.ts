...
async function p_basicDataLoad(key: string): Promise<ThemeData | undefined> {
    const result = await ExtensionStorageProvider.loadKey(key);
    if (result == null) {
...
export class DataManager {
    ...
    saveThemes() {
        ...
        ExtensionStorageProvider.storeKey("themes", this.currentThemes);
    }

    saveData() {
        console.log("Save: ", this.currentData);
        ExtensionStorageProvider.storeKey("themeData", this.currentData);
    }

    saveSettings() {
        console.log("Save: ", this.currentSettings);
        ExtensionStorageProvider.storeKey("settings", this.currentSettings);
    }
