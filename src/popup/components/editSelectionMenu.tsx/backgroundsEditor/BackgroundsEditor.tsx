...
export function BackgroundsEditorPage() {
    ...
    const onFBEChanged = (v: boolean) => {
        dataManagementService.dataManager.currentData.backgrounds[
            "fullBackgroundExperience"
        ] = v ? "true" : "false";
    ...
    const onURLChanged = (e: React.FocusEvent<HTMLInputElement>) => {
        dataManagementService.dataManager.currentData.backgrounds[
            "channelAndChatBackground"
        ] = e.target.value;
        dataManagementService.dataUpdated();
    };

    const onInterfaceOpacityChanged = (
    ...
    return (
        <div className="w-full flex flex-col items-center px-2 animate-fadeIn">
            {/* FBE Switch */}
            <div className="w-full flex items-center px-2 py-1 justify-between">
                ...
                <ToggleSwitch
                    name="fbe_toggle"
                    value={
                        data.backgrounds["fullBackgroundExperience"] === "true"
                    }
                    onClick={onFBEChanged}
                ></ToggleSwitch>
            </div>
            ...
            <div className="w-full flex flex-col items-center">
                <div className={sectionClasses}>
                    ...
                    <div className="w-[40vw] h-[85%]">
                        <TeamsPlusInput
                            defaultValue={
                                data.backgrounds["channelAndChatBackground"]
                            }
                            type="text"
                            onBlur={onURLChanged}
                        ></TeamsPlusInput>
                ...
                <div className={sectionClasses}>
                    ...
                    <div className="w-[40vw] h-[85%]">
                        <TeamsPlusInput
                            defaultValue={data.backgrounds["interfaceOpacity"]}
                            type="number"
                            onBlur={onInterfaceOpacityChanged}
                        ></TeamsPlusInput>
                    </div>
                </div>
                <div className={sectionClasses}>
                    ...
                    <div className="w-[40vw] h-[85%]">
                        <TeamsPlusInput
                            defaultValue={data.backgrounds["backdropFilter"]}
                            type="text"
                            onBlur={onBackdropFilterChanged}
                        ></TeamsPlusInput>
                    </div>
                </div>
            </div>
